...
import com.abstratt.easyalpha.core.domain.ErrorCode
import com.abstratt.easyalpha.core.domain.FilteredService
...
abstract class BaseController<T : BaseEntity, DTO : BaseDTO, S : FilteredService<T, *>> {
    @Autowired
